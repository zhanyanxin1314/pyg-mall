...
namespace capt;
	...
	class clicaptcha{
		...
		public function creat(){
			$imagePathArr = array('/public/static/index/img/1.jpg', '/public/static/index/img/2.jpg', '/public/static/index/img/3.jpg');
			$imagePath = $imagePathArr[rand(0, count($imagePathArr) - 1)];
			$fontPath = '/public/static/common/font/SourceHanSansCN-Normal.otf';
		...
		private function randChars($length = 4){
			 ...
			 * @return string
			 */
			function my_msubstr($str, $start = 0, $length, $charset = 'utf-8', $suffix = true){
			...
			for($i = 0; $i < $length; $i++){
				$return[] = my_msubstr($chars, floor(mt_rand(0, mb_strlen($chars, 'utf-8') - 1)), 1, 'utf-8', false);
			}
			return $return;
		}
		//随机生成位置布局
