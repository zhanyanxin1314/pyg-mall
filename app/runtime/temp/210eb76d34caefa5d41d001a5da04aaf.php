<?php /*a:4:{s:76:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\info.html";i:1562038698;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
<script src="/static/index/js/info.js" type="text/javascript"></script>
                ...
                <div class="yui3-u-5-6">
                    <div class="body userInfo">
                       <div class="infoList" style="margin-bottom:10px;">
							<div class="mt">
								<span class="fl"><strong>个人信息</strong></span>
							</div>
						</div>
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                <form id="userEditForm" class="sui-form form-horizontal">
                                	<div class="control-group">
                                        <label for="inputName" class="control-label">登陆账号：</label>
                                        <div class="controls">
                                            <input disabled="disabled" type="text" value="<?php echo htmlentities($list['loginName']); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="nickName" class='ipt' name="nickName" placeholder="昵称" value="<?php echo htmlentities($list['nickName']); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputName" class="control-label">真实姓名：</label>
                                        <div class="controls">
                                            <input type="text" id="trueName" class='ipt' name="trueName" placeholder="真实姓名" value="<?php echo htmlentities($list['trueName']); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputName" class="control-label">Email：</label>
                                        <div class="controls">
                                            <input type="text" id="userEmail" class='ipt' name="userEmail" placeholder="Email" value="<?php echo htmlentities($list['userEmail']); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="radio" name="userSex" id="userSex" class='ipt' value="1" <?=($list['userSex']==1)?'checked':'';?> ><span>&nbsp;男</span>
                                            <input type="radio" name="userSex" id="userSex" class='ipt' value="2" <?=($list['userSex']==2)?'checked':'';?>><span>&nbsp;女</span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputPassword" class="control-label">生日：</label>
                                        <div class="controls">
                                             <input style="height:25px;" type="text" class="layui-input ipt" id="brithday" name="brithday" value="<?php echo htmlentities($list['brithday']); ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputName" class="control-label">QQ：</label>
                                        <div class="controls">
                                            <input type="text" id="userQQ" class='ipt' name="userQQ" placeholder="QQ" value="<?php echo htmlentities($list['userQQ']); ?>">
                                        </div>
                                    </div>
                                    <input type="hidden" name="id" id="userId" class="ipt" value="<?php echo htmlentities($userId); ?>" />
                                    <div class="control-group">
                                        <label for="sanwei" class="control-label"></label>
                                        <div class="controls">
                                            <button type="submit" class="sui-btn btn-primary">立即提交</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
