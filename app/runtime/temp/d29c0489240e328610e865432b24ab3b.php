<?php /*a:4:{s:87:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\complain_detail.html";i:1563434318;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
<script type="text/javascript" src="/static/index/js/inform.js"></script>
                    ...
                    <div class="body">
                        ...
                        <div class="order-goods">
                            <table class="sui-table">
                                    <thead>
                                        <th class="center" >投诉信息</th>
                                    </thead>
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="typographic">
                                                    <span>订单编号 <?php echo htmlentities($data['orderNo']); ?></span>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div  style="display: inline-block;vertical-align:top;"><font color='red'>*</font>投诉类型：</div>
                         <div  style="display: inline-block">



                            <label><input type='radio' name='complainType' class='ipt' autocomplete="off" value='1' <?php if($data['complainType'] ==1): ?>checked<?php endif; ?>>承诺的没有做到</label>
                            &nbsp;&nbsp;
                            <label><input type='radio' name='complainType' class='ipt' autocomplete="off" value='2' <?php if($data['complainType'] ==2): ?>checked<?php endif; ?>>未按约定时间发货</label>

                            <label><input type='radio' name='complainType' class='ipt' autocomplete="off" value='3' <?php if($data['complainType'] ==1): ?>checked<?php endif; ?>>未按成交价进行交易</label>
                            &nbsp;&nbsp;
                            <label><input type='radio' name='complainType' class='ipt' autocomplete="off" value='4' <?php if($data['complainType'] ==2): ?>checked<?php endif; ?>>恶意骚扰</label>

                         </div>

                        <div style="margin-top: 10px;margin-bottom: 10px;"><font color='red'>*</font>投诉内容：
                          	<?php echo htmlentities($data['complainContent']); ?>
                        </div>
 						<div  style="display: inline-block;vertical-align:top;margin-top: 10px;"><font color='red'>*</font>投诉时间：</div>
                         <div  style="display: inline-block;margin-top: 10px;">
                          	<?php echo htmlentities($data['complainTime']); ?>
                         </div>
                        <div style="margin-top: 10px;margin-bottom: 10px;"><font color='red'>*</font>投诉结果：
                          <?php if($data['complainStatus'] == 0): ?>
                                            等待处理
			              <?php elseif($data['complainStatus'] == 1): ?>
			                                等待应诉人回应
			              <?php elseif($data['complainStatus'] == 2 OR $data['complainStatus'] == 3): ?>
			                                          等待仲裁
			              <?php elseif($data['complainStatus'] == 4): ?>
			                                          已仲裁                        
			              <?php endif; ?>
                        </div>
                        <div style="text-align: center;margin-top:10px;">
                         <a href='<?php echo Url("index/center/complains"); ?>' class="layui-btn layui-btn-primary">返回列表</a>
                        </div>
                      </form>
                    </div>
                </div>
