<?php /*a:4:{s:77:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\order.html";i:1568624471;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
						...
						<div class="order-detail">
							<div class="ever">
								<ul class="sui-nav nav-tabs">
									<li class="active">
										<a href="#all" data-toggle="tab">全部订单<i class="mark"><?php echo htmlentities($list['totalOrders']); ?></i></a>
									</li>
									<li>
										<a href="#pay" data-toggle="tab">待付款<i class="mark"><?php echo htmlentities($list['waitTotal']); ?></i></a>
									</li>
									<li>
										<a href="#receive" data-toggle="tab">待收货<i class="mark"><?php echo htmlentities($list['receveTotal']); ?></i></a>
									</li>
									<!--<li>
										<a href="#remark" data-toggle="tab">待评价<i class="mark"><?php echo htmlentities($list['appraiseTotal']); ?></i></a>
									</li>-->
								</ul>
								...
								<div class="tab-content">
									...
									<div id="all" class="tab-pane active">
										<div class="orders">
											<table class="sui-table table-bordered">
												<?php if(is_array($list['orders']) || $list['orders'] instanceof \think\Collection || $list['orders'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['orders'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
												<thead>
													<tr>
														<th colspan="5">
															<span class="ordertitle"><?php echo htmlentities($vo['createTime']); ?>　订单编号：<?php echo htmlentities($vo['orderNo']); ?> <!--<span class="pull-right delete"><img src="/static/index/img/delete.png"/></span>--></span>
														</th>
													</tr>
												</thead>
												<tbody>
													...
													<tr>
														...
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>"  class="center">
															<ul class="unstyled">
															<?php if($vo['payType'] == 0 && $vo['orderStatus'] == 0): ?> 待发货
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == -2): ?>待付款
															<?php elseif($vo['payType'] == 0 && $vo['orderStatus'] == 1): ?>待收货
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == 1): ?>待收货
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == 0): ?>待发货
															<?php elseif($vo['payType'] == 0 && $vo['orderStatus'] == 2): ?>已收货
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == 2): ?>已收货
															<?php endif; ?>
															</ul>
														</td>
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="8%" class="center">
															<a href="#" class="btn">
															<?php if($vo['payType'] == 0 && $vo['orderStatus'] == 0): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<a onclick="cancelOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">取消订单</a><br /><br />
																
																<!--<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">评价晒单</a>-->
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == -2): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<a onclick="cancelOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">取消订单</a><br /><br />
																<a href='<?php echo Url("index/orders/succeed",["orderNo"=>$vo["orderNo"],"isBatch"=>0]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">立即付款</a>
															<?php elseif($vo['payType'] == 0 && $vo['orderStatus'] == 1): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<a onclick="takeOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">确认收货</a><br />																	
															
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == 0): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<a onclick="cancelOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">取消订单</a><br /><br />
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == 1): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<a onclick="takeOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">确认收货</a><br />	
															<?php else: ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<?php if($vo['isComplains'] == 0): ?>
																<a onclick='complain(<?php echo htmlentities($vo["orderId"]); ?>,"finish")' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单投诉</a><br /><br />
																<?php endif; if($vo['isAppraise'] == 0): ?>
																	<a href='<?php echo Url("index/center/toAppraise",["orderId"=>$vo["orderId"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">评价晒单</a>
																<?php endif; ?>
															<?php endif; ?>
															</a>
														</td>
									...
									<div id="pay" class="tab-pane">
										<div class="orders">
											<table class="sui-table table-bordered">
												<?php if(is_array($list['waitPayOrders']) || $list['waitPayOrders'] instanceof \think\Collection || $list['waitPayOrders'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['waitPayOrders'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
												<thead>
													<tr>
														<th colspan="5">
															<span class="ordertitle"><?php echo htmlentities($vo['createTime']); ?>　订单编号：<?php echo htmlentities($vo['orderNo']); ?> <span class="pull-right delete"><img src="/static/index/img/delete.png"/></span></span>
												...
												<tbody>
													...
													<tr>
														...
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="8%" class="center">
															...
															<?php if($vo['payType'] == 0 && $vo['orderStatus'] == 0): ?>
															<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
															<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">评价</a><br /><br />
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == -2): ?>
															<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
															<a onclick="cancelOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">取消订单</a><br /><br />
															<a href='<?php echo Url("index/orders/succeed",["orderNo"=>$vo["orderNo"],"isBatch"=>0]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">立即付款</a><br /><br />
															<?php else: ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br />														
															<?php endif; ?>
															</a>
														</td>
														<?php endif; ?>
									...
									<div id="receive" class="tab-pane">
										<div class="orders">
											<table class="sui-table table-bordered">
												<?php if(is_array($list['receveOrders']) || $list['receveOrders'] instanceof \think\Collection || $list['receveOrders'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['receveOrders'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
												<thead>
													<tr>
														<th colspan="5">
															<span class="ordertitle"><?php echo htmlentities($vo['createTime']); ?>　订单编号：<?php echo htmlentities($vo['orderNo']); ?> <span class="pull-right delete"><img src="/static/index/img/delete.png"/></span></span>
												...
												<tbody>
													...
													<tr>
														...
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="8%" class="center">
															<a href="#" class="btn">
															<?php if($vo['payType'] == 0 && $vo['orderStatus'] == 2): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger"  target="_blank">评价</a>
															<?php elseif($vo['payType'] == 1 && $vo['orderStatus'] == 0): ?>
																<a href='<?php echo Url("index/center/orderDetail",["orderNo"=>$vo["orderNo"]]); ?>' style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger" target="_blank">订单详情</a><br /><br />
																<a onclick="cancelOrders(<?php echo htmlentities($vo['orderId']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">取消订单</a><br /><br />
															<?php else: ?>
