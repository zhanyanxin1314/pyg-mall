<?php /*a:3:{s:85:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\orders\order_success.html";i:1561971389;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
<link rel="stylesheet" type="text/css" href="/static/index/css/pages-pay.css" />
		...
		<div class="cart py-container">
			...
			<div class="checkout py-container  pay">
				<div class="checkout-tit">
					<h4 class="tit-txt"><span class="success-icon"></span><span  class="success-info">订单提交成功!</span></h4>
					<div class="paymark">
						<?php if(is_array($object['list']) || $object['list'] instanceof \think\Collection || $object['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $object['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<span class="fl">订单号：<em><a href='<?php echo url("/index/center/orderDetail",array("orderNo"=>$vo["orderNo"])); ?>'><?php echo htmlentities($vo['orderNo']); ?></a></em></span>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						<span class="fr"><em class="sui-lead">应付金额：</em><em  class="orange money">￥<?php echo htmlentities($object['totalMoney']); ?></em></span>
					</div>
				</div>
				<div class="checkout-steps">
					<div class="submit sui-text-center">
						<a class="sui-btn btn-danger btn-xlarge" href="/" target="_blank">继续购物</a>
					</div>
				</div>
			</div>
		</div>
