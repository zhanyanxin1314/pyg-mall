<?php /*a:4:{s:78:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\inform.html";i:1563503595;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
	...
	<dl>
		...
		<a style="text-decoration:none;color:#333;" href="<?php echo Url('index/center/safe'); ?>"><dd <?php if($nav =='safe'): ?>class="active"<?php endif; ?>> 安全设置</dd></a>
					...
					<div class="yui3-u-5-6 body">
						<div class="order">
							<div class="mt">
								<span class="fl"><strong >违规举报</strong></span>
							</div>
						</div>
											...
											<div class="chosetype">
												<table class="sui-table table-bordered-simple">
													<thead>
														<tr>
															<th>举报编号</th>
															<th style="width:40%">举报商品</th>
															<th style="width:20%">举报原因</th>
															<th>举报时间</th>
															<th style="width:10%">举报状态</th>
															<th>操作</th>
														</tr>
													</thead>
													</tbody>
											...
											<table class="sui-table table-bordered" >
												...
												<tbody>
													...
													<tr>
														<td width="10%">
															<ul class="unstyled">
																<li><?php echo htmlentities($vo['informId']); ?></li>
															</ul>
														</td>
														<td width="40%" class="center"><?php echo htmlentities($vo['goodsName']); ?></td>
														<td width="20%" class="center">
															<ul class="unstyled">
																<li><?php echo htmlentities($vo['informContent']); ?></li>
																
															</ul>
														</td>
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>"  class="center">
															<ul class="unstyled">
																<?php echo htmlentities($vo['informTime']); ?>
															</ul>
														</td>
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>"  class="center">
															<ul class="unstyled">
																<?php echo htmlentities($vo['informStatus']); ?>
															</ul>
														</td>
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="8%" class="center">
															<a onclick="toView(<?php echo htmlentities($vo['informId']); ?>)" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">查看</a><br /><br />
														</td>
													</tr>
