<?php /*a:4:{s:80:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\appraise.html";i:1568624545;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
	...
	<dl>
		...
		<a style="text-decoration:none;color:#333;" href="<?php echo Url('index/center/safe'); ?>"><dd <?php if($nav =='safe'): ?>class="active"<?php endif; ?>> 安全设置</dd></a>
					...
					<div class="yui3-u-5-6 body">
						<div class="order">
							<div class="mt">
								<span class="fl"><strong >评价晒单</strong></span>
							</div>
						</div>
								...
								<div class="tab-content">
											<div class="chosetype">
												<table class="sui-table table-bordered-simple">
													<thead>
														<tr>
															<th style="width:40%">订单详情</th>
															<th style="width:17%">商品评分</th>
															<th style="width:17%">时效评分</th>
															<th style="width:17%">服务评分</th>
															<th>评价内容</th>
														</tr>
													</thead>
													</tbody>
											...
											<table class="sui-table table-bordered">
												...
												<thead>
													<tr>
														<th colspan="5">
															<span class="ordertitle"><?php echo htmlentities($vo['createTime']); ?>　订单编号：<?php echo htmlentities($vo['orderNo']); ?></span>
														</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														<td width="40%">
															<div class="typographic"><img style="width:100px;height:100px;" src="<?php echo htmlentities($vo['goodsImg']); ?>" />
																<a target="_blank" href='<?php echo Url("index/goods/detail",["goodsId"=>$vo["goodsId"]]); ?>' class="block-text"><?php echo htmlentities($vo['goodsName']); ?></a><span>x<?php echo htmlentities($vo['goodsNum']); ?></span>
															</div>
														</td>
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="20%" class="center">
																<?php $__FOR_START_610916890__=0;$__FOR_END_610916890__=$vo['goodsScore'];for($i=$__FOR_START_610916890__;$i < $__FOR_END_610916890__;$i+=1){ ?>
																	<img src='/static/admin/img/icon_score_yes.png'>
																<?php } ?>
														</td>
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="20%" class="center">
															<ul class="unstyled">
																<li>
																<?php $__FOR_START_1189931491__=0;$__FOR_END_1189931491__=$vo['timeScore'];for($i=$__FOR_START_1189931491__;$i < $__FOR_END_1189931491__;$i+=1){ ?>
																	<img src='/static/admin/img/icon_score_yes.png'>
																<?php } ?>
																</li>
															</ul>
														...
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="20%"  class="center">
															<ul class="unstyled">
																<?php $__FOR_START_1002771340__=0;$__FOR_END_1002771340__=$vo['serviceScore'];for($i=$__FOR_START_1002771340__;$i < $__FOR_END_1002771340__;$i+=1){ ?>
																	<img src='/static/admin/img/icon_score_yes.png'>
																<?php } ?>
														...
														<td rowspan="<?php echo htmlentities($vo['goods']['totalk']); ?>" width="8%" class="center">
															<a onclick="showAppraise(<?php echo htmlentities($vo['id']); ?>);" style="text-decoration:none;" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">查看内容</a><br /><br />
														</td>
													</tr>
												</tbody>
												<div style="display:none;margin:10px 10px;height:400px;width:300px;" id="content1"><?php echo htmlentities($vo['content']); ?></div>
