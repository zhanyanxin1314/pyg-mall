<?php /*a:3:{s:77:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\goods\detail.html";i:1563355756;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					...
					<?php $_result=PYGPathGoodsCat($goods['goodsCatId']);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<li>
			...
			<div class="product-info">
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img style="width: 400px;" jqimg="" src="<?php echo htmlentities($goods['goodsImg']); ?>" /></span>
				...
				<div class="fr itemInfo-wrap">
					<div class="sku-name">
						<h4><?php echo htmlentities($goods['goodsName']); ?></h4>
					</div>
					...
					<div class="summary">
						<div class="summary-wrap">
							...
							<div class="fl price">
								<i>¥</i>
								<em><?php echo htmlentities($goods['marketPrice']); ?></em>
							</div>
							<div class="fr remark">
						...
						<div class="summary-wrap">
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="javascript:addCart(<?php echo htmlentities($goods['goodsId']); ?>)" class="sui-btn  btn-danger addshopcar">加入购物车</a>
