<?php /*a:4:{s:76:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\safe.html";i:1563518008;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
<script type="text/javascript" src="/static/index/js/safe.js"></script>
<script>
    $(function(){veMyorm();})
</script>
	...
	<dl>
		...
		<a style="text-decoration:none;color:#333;" href="<?php echo Url('index/center/safe'); ?>"><dd <?php if($nav =='safe'): ?>class="active"<?php endif; ?>> 安全设置</dd></a>
                ...
                <div class="yui3-u-5-6">
                    <div class="safeList" style="margin-bottom:10px;">
                            <div class="mt">
                                <span class="fl"><strong>安全设置</strong></span>
                            </div>
                        </div>
                    <div class="body userSafe">
                        ...
                        <div class="tab-content ">
                            <div id="one" class="tab-pane active">
                                <form class="sui-form form-horizontal sui-validate" id="passForm">
                                    <div class="control-group">
                                        <label for="inputusername" class="control-label">原始密码：</label>
                                        <div class="controls">
                                            <input id='oldPass' name='oldPass' class="ipt fn-tinput"  type="password" <?php if(($data['loginPwd'])): ?>data-rule="原始密码: required;" data-msg-required="请填写原始密码" data-tip="请输入原始密码"<?php endif; ?> maxLength='16'
                                            />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="ipt fn-tinput" type="password" id="newPass" name="newPass" maxLength='16'>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="inputRepassword" class="control-label">重复密码：</label>
                                        <div class="controls">
                                            <input class="ipt fn-tinput" type="password" name="reNewPass" id="reNewPass" maxLength='16'>
                                        </div>
                                    </div>
                                    <div class="control-group">
                            ...
                            <!--<div id="two" class="tab-pane">
                                ...
                                <form class="sui-form form-horizontal sui-validate" data-toggle='validate' id="bind-form">
                                    ...
                                    <div class="control-group next-btn">
                                        <a class="sui-btn btn-primary" href="#">下一步</a>
                                    </div>
                                </form>
                            </div>-->
                        </div>
