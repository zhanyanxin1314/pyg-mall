<?php /*a:5:{s:79:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\center\history.html";i:1563519190;s:71:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\layout.html";i:1563936177;s:68:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\top.html";i:1563935465;s:69:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\left.html";i:1563517946;s:70:"E:\phpStudy\PHPTutorial\WWW\mall\app\application\index\view\duibi.html";i:1560842897;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
	...
	<dl>
		...
		<a style="text-decoration:none;color:#333;" href="<?php echo Url('index/center/safe'); ?>"><dd <?php if($nav =='safe'): ?>class="active"<?php endif; ?>> 安全设置</dd></a>
                ...
                <div class="yui3-u-5-6 goods">
                    <div class="body">
                            <div style="border:1px solid #ddd;margin: 0 0 12px;overflow:hidden;padding: 12px 10px;background-color: #f1f1f1;font-size:15px;">浏览历史</div>
								...
								<?php if(is_array($list['data']) || $list['data'] instanceof \think\Collection || $list['data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <li class="yui3-u-1-4">
                                        <div class="list-wrap">
                                            ...
                                            <div class="cu" style="height:30px;"><em>浏览&nbsp;<span><?php echo htmlentities($vo['score']); ?></span>&nbsp;次</em></div>
                                            <div class="operate">
